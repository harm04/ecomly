...
class VendorOrderProvider extends StateNotifier<List<OrdersModel>> {
  VendorOrderProvider() : super([]);
...
final vendorOrdersProvider = StateNotifierProvider<VendorOrderProvider, List<OrdersModel>>(
  (ref) => VendorOrderProvider(),
);
